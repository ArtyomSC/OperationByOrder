...
public class CashValuablesReceptionByOrderPage extends BasePage {
    private By currencyKindLabel = By.xpath("//*[@id='main-content-form:kind_label']");
    private By currencyBynKind = By.xpath("//*[@data-label='Белорусский рубль']");
    private By amountByDocument = By.xpath("//*[@id='main-content-form:amount_input']");
    private By receivedInput = By.xpath("//*[@id='main-content-form:input-table:0:received_input']");
    private By proceedButton = By.xpath("//*[@id='main-content-form:confirm']");
